...
Usage:
    python -m llm_stress run --workload shared_prefix --duration 60
    python -m llm_stress run --workload cancel_mix --arrival poisson --rate 20
    python -m llm_stress summarize --events out/run.jsonl
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="llm_stress")
